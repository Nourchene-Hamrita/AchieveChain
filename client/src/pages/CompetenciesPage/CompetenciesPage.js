...
import Competencie from "../../components/competencies/Competencies";
...
const CompetenciesPage = () => {
    ...
    return (
        <div className="container-list-competencies">
            <Grid
                container
                spacing={3}
                style={{
            ...
            >
                <Grid item xs={10}>
                    <Paper style={{ position: "relative", padding: 16,width:810 }}>
